            ...
            <form class="form-horizontal form-management" id="form-management">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9"><select class="form-control product-name" id="choose-product"
                                                      name="product-name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9"><select class="form-control sector-name" name="sector-name">
                                <option>Add as sector</option>
                                <!--                                    --><?php //foreach($listSector as $sector): ?>
                                <!--                                        <option value="-->
                                <?php //echo $sector['id'] ?><!--">-->
